...
public class ModuleDslSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_IF_INSTR_EqualsSignGreaterThanSignKeyword_7_1_q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_IF_INSTR_EqualsSignGreaterThanSignKeyword_7_1_q = new TokenAlias(false, true, grammarAccess.getIF_INSTRAccess().getEqualsSignGreaterThanSignKeyword_7_1());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if(match_IF_INSTR_EqualsSignGreaterThanSignKeyword_7_1_q.equals(syntax))
				emit_IF_INSTR_EqualsSignGreaterThanSignKeyword_7_1_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     '=>'?
	 */
	protected void emit_IF_INSTR_EqualsSignGreaterThanSignKeyword_7_1_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
